<form id="payment-ol" action="{{route('action_payment_method')}}" method="post">
	...
	<div class="list-payment">
		...
		<div style="display: none;" id="nlpayment">
		...
		<input name="method_payment" value="2" class="d-none">
		<div class="">
			<button type="submit" class="hs-btn hs-btn-green hs-btn-lg">Thanh toán</button>
		</div>
	</div>
</form>
